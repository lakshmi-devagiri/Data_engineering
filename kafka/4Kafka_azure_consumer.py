...
if __name__ == "__main__":
    ...
    emission_df_parsed.withColumn("current_timestamp",
                                  (unix_timestamp() + emission_df_parsed.timestep_time).cast('timestamp'))

    pollution_data = emission_df_parsed.groupBy(
        window("current_timestamp", window_duration, slide_duration).alias("Date"), col("vehicle_lane").alias("LaneId")) \
        .agg(
...
#https://raw.githubusercontent.com/NastasijaaS/Big-Mobility-Data-Stream-Analytics/029a3759885c239c3c01c6fe950042da9a0e2cc3/streaming/streamingapp/streaming.py
